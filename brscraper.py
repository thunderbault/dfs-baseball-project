...
class BRScraper:
    ...
    def parse_tables(self, resource, pitcher=None, table_ids=None, verbose=False):
        """
        ...
        for table in tables:
            ...
            for header in headers:
                ...
                try:
                    real_base_header_name = base_header_name.split(">")
                    base_header_name = real_base_header_name[1]
            ...
            for row in rows:
                ...
                if isinstance(pitcher, str):
                    if pitcher.title() in entries:
                        entry_data = []
                        try:
                            entry_data.append(row.a.string.strip())
                        except:
                            continue
