#create optimized daily fantasy baseball lineup using data from SQL generated by complete
#Currently only Draftkings operational
#By Adam Thibault
...
#wind effects to be added later
...
#roof effects  to be added later
...
#temperature effects to be added later

temp_high = 90
temp_low = 40

#precipitation effects to be added later
...
def ballparkfactorsscraper(object):
    '''
    scrape for ballpark factors from ballparkfactors_url
    '''
    data = []
...
def dk_score_from_sql(player_full_name, position, year):
    '''
    Uses SQL data to calculate score for each player based on Draftkings scoring
    '''
    score = 0
    divisor = 0
...
# def fd_score_from_sql(player_full_name, position):
    # '''
    # Pulls data from SQL and calculates score based on FanDuel scoring
    # '''
...
# def extract_fd_info(csv_from_draftkings):
    # '''
    # Extract salary and position data form FannDuel CSV
    # '''
